// fetch('https://finance.yahoo.com/rss/')
//     .then(resp => resp.text())
//     .then(data => {
//         let parser = new DOMParser();
//         let xml = parser.parseFromString(data, 'text/xml');
//         console.log(xml.querySelectorAll('channel item'));
//     })
const fs = require('fs');
...
(async function main() {
    ...
    const feed = await parser.parseURL("https://finance.yahoo.com/rss/"); // https://www.reddit.com/.rss
